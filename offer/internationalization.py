spanish = {
    ...
    "ERROR_PAYPAL_CREDENTIALS": "Las credenciales de PayPal no son correctas. Puedes modificarla en la sección \"Mi cuenta\"",
...
english = {
    ...
    "ERROR_PAYPAL_CREDENTIALS": "Incorrect PayPal credentials. You can modify it on \"My account\" section",
