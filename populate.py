    ...
    system_configuration1 = SystemConfiguration.objects.create(minimumPrice='20', currency='EUR', paypalTax='2.9',
        ...
        privacyText="<h1>Privacy policy</h1>" +
                    ...
                    termsText="<h1>Terms & conditions</h1>" 
                              ...
                              "responsible for the interruption, suspension or termination of the information or " +
                              "services. Likewise, it is not responsible for possible omissions, loss of " +
                              "information, data, configurations, improper access or vulnerabilities of " +
                              "confidentiality that have their origin in technical problems, communications or human " +
                              "omissions, caused by third parties or not attributable to the portal. The portal may, " +
                              " in its sole discretion, deny, withdraw, suspend and/or block at any time and without " +
                              "prior notice, access to the information and services included in this document.<p>" +
                              ...
                              "parties in and / or through the portal. The user accepts that the website does " +
                              "not assume any responsibility for any loss or damage as a result of the use of " +
                              "this information or services of third parties.</p>" +
                              "<p>Except for cases that the Law expressly imposes otherwise, and exclusively with " +
                              "the extent and extent to which it imposes it, the application does not guarantee or " +
                              "assume any responsibility with respect to possible damages caused by the use and " +
                              "use of the information, data and portal services.</p>" +
                              ...
                              "<p>The user is obliged, in those cases that request data or information, not to " +
                              "falsify their identity by posing as any other person. The user accepts that the use " +
                              "of the Portal will be carried out for strictly personal, private and private " +
                              "purposes. The user can not use the portal for activities contrary to the Law, " +
                              "morals and public order as well as for prohibited purposes or that violate or harm " +
                              "the rights of third parties. Likewise, the dissemination, storage and / or " +
                              "management of data or contents that infringe the rights of third parties or any " +
                              "regulatory regulations of intellectual or industrial property rights is " +
                              "prohibited.</p>" +
                              ...
                              "any program or equipment. IT or telecommunications. </p><p>The user undertakes to " +
                              "indemnify and hold harmless the portal for any damage, prejudice, penalty, fine, " +
                              "penalty or compensation that the portal has to face.</p>" +
                              "<h2>Cookies</h2><p>We employ the use of cookies. By accessing Grooving group, you " +
                              "agreed to use cookies in agreement with the Grooving's Privacy Policy.</p>" +
                              ...
                              "Website.</p><h2>License</h2<p>Unless otherwise stated, Grooving and/or its licensors " +
                              "own the intellectual property rights for all material on Grooving. All intellectual " +
                              "property rights are reserved. You may access this from Grooving for your own personal" +
                              ...
                              "<h2>Delete your personal information</h2>" +
                              "<p>In case you want to erase your system, you must send an email to " +
                              "<b>grupogrooving@gmail.com</b> requesting.</p>")
